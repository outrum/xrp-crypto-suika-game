...
const Game = {
	...
	fruitSizes: [
		{ radius: 24,  scoreValue: 1,  img: './assets/new_generated/resized_cropped_super_opt_optimized_xrpl_coin.png', name: "Baby Ripple" },
		{ radius: 32,  scoreValue: 3,  img: './assets/new_generated/resized_cropped_super_opt_optimized_xrpl_coin.png', name: "XRP Coin" },
		{ radius: 40,  scoreValue: 6,  img: './assets/new_generated/resized_cropped_optimized_rocket_fuel_vertical.png', name: "Rocket Fuel" },
		{ radius: 56,  scoreValue: 10, img: './assets/new_generated/resized_cropped_optimized_diamond.png', name: "Diamond Hands" },
		{ radius: 64,  scoreValue: 15, img: './assets/new_generated/resized_cropped_optimized_hold_shield.png', name: "HODL Shield" },
		{ radius: 72,  scoreValue: 21, img: './assets/new_generated/resized_cropped_optimized_whale_circular.png', name: "Crypto Whale" },
		{ radius: 84,  scoreValue: 28, img: './assets/new_generated/resized_cropped_optimized_rocket_vertical.png', name: "Rocket Launch" },
		{ radius: 96,  scoreValue: 36, img: './assets/new_generated/resized_cropped_optimized_rocket_vertical.png', name: "Moon Base" },
		{ radius: 128, scoreValue: 45, img: './assets/new_generated/resized_cropped_super_opt_optimized_Spiral_galaxy_formation.png', name: "Crypto Galaxy" },
		{ radius: 160, scoreValue: 55, img: './assets/new_generated/resized_cropped_optimized_hodl_square.png', name: "Interstellar XRP" },
		{ radius: 192, scoreValue: 66, img: './assets/new_generated/resized_cropped_optimized_crown.png', name: "Crypto God" },
	],
	currentFruitSize: 0,
	nextFruitSize: 0,
